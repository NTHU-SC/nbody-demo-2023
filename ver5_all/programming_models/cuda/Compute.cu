...
void GSimulation :: start() 
{
  ...
  cudaMalloc((void**)&particles_acc_z_d, n * sizeof(real_type));

  cudaMalloc((void**)&particles_mass_d, n * sizeof(real_type));
  ...
  cudaMemcpy(particles_mass_d, particles->mass, n * sizeof(real_type), cudaMemcpyHostToDevice);
  ...
  {   
    ...
    cudaMemcpy(particles->acc_x, particles_acc_x_d, n * sizeof(real_type), cudaMemcpyDeviceToHost);
    cudaMemcpy(particles->acc_y, particles_acc_y_d, n * sizeof(real_type), cudaMemcpyDeviceToHost);
    cudaMemcpy(particles->acc_z, particles_acc_z_d, n * sizeof(real_type), cudaMemcpyDeviceToHost);
